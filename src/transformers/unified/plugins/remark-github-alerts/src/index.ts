/*
 * THIS PLUGIN IS A FORK OF https://github.com/hyoban/remark-github-alerts PLUGIN.
 * @contributors https://github.com/hyoban/remark-github-alerts/graphs/contributors and https://github.com/babakfp.
 */
    ...
    return (tree) => {
        visit(tree, "blockquote", (node, index, parent) => {
            ...
            node.data = {
                hName: "div",
                hProperties: {
                    class: `remark-github-alerts remark-github-alerts-${type}`,
                },
            }
            node.children = [
                {
